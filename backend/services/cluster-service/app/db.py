...
from .models import UserDocument, PaperDocument, ClusterDocument  # Import all models here
...
async def init():
    ...
    await init_beanie(database, document_models=[UserDocument, PaperDocument, ClusterDocument])
